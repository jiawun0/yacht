            ...
            <div class="menu">
                <ul>
                    ...
                    <li class="menuli02"><a href="/newsFront2">
                        <img width="71px" height="71px">NEWS</a></li>
                    <li class="menuli03"><a href="/conpanyFront">
                        <img width="71px" height="71px">COMPANY</a></li>
                    <li class="menuli04"><a href="/dealersFront">
                        <img width="71px" height="71px">DEALERS</a></li>
                    <li class="menuli05"><a href="/contactFront">
                        <img width="71px" height="71px">CONTACT</a></li>--%>
